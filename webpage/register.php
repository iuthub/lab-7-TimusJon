    ...
    <form action="register.php" method="post">
        ...
        <ul class="form">
            <li>
                ...
                <input type="text" name="username" id="username" <?php if (isset($_SESSION["user"])) { ?> value="<?= $_SESSION["user"]["username"] ?>" <?php 
                                                                                                                                                } else { ?> value="<?= $username ?>" <?php 
                                                                                                                                                                                            } ?> required />
            </li>
            <li>
                <label for="fullname">Full Name</label>
                <input type="text" name="fullname" id="fullname" <?php if (isset($_SESSION["user"])) { ?> value="<?= $_SESSION["user"]["fullname"] ?>" <?php 
                                                                                                                                                } else { ?> value="<?= $fullname ?>" <?php 
                                                                                                                                                                                            } ?> required />
            </li>
            <li>
                <label for="email">Email</label>
                <input type="email" name="email" id="email" <?php if (isset($_SESSION["user"])) { ?> value="<?= $_SESSION["user"]["email"] ?>" <?php 
